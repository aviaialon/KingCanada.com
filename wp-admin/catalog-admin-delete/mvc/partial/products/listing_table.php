  ...
  <ul class="nav navbar-nav navbar-right collapse" id="navbar-menu-right">
    <li class="dropdown"> 
      ...
      <ul class="dropdown-menu icons-right dropdown-menu-right">
        <li><a href="#" data-action="enable" class="bulk_action"><i class="icon-checkmark4"></i> Enable Selected</a></li>
        <li><a href="#" data-action="disable" class="bulk_action"><i class="icon-angry"></i> Disable Selected</a></li>
      </ul>
    </li>
  </ul>
</div>
...
<div class="panel panel-default" id="reportProducts">
  <div class="panel-heading">
    <h6 class="panel-title"><i class="icon-table"></i> Product Catalog <span class="label label-danger"><?php echo(count($products)); ?></span></h6>
  </div>
        ...
        <tr id="p_<?php echo $product['id']; ?>">
          ...
          <td class="text-center">
            <div class="btn-group">
          	...
          	<?php /*?><div id="remote_modal_<?php echo $product['id']; ?>" class="modal fade" tabindex="-1" role="dialog" style="text-align:left">
