<?php get_header(); ?>
 ...
 <div class="d-4of5">
								<header class="article-header">
									...
									<h3 class="h1 entry-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3>
								...
								<section class="entry-content cf">
									...
									<?php the_post_thumbnail( 'bones-featured' ); ?>
...
<div class="d-1of5 newsSidebar">
								<footer class="article-footer">
									<a href="#" class="shareRight"><span class= "icon-fbook"></span> Share on facebook</a><br>
									<a href="#" class="shareRight"><span class= "icon-mail"></span> Share by email</a>
								</footer>
