<?php
/*
 Template Name: Product Search Results Page
 *
...
$pagination = \Core\Hybernate\Products\Product::search($_GET['q']);
...
<?php get_header(); ?>
    ...
    <div id="signup">
        <div class="wrap cf rightfloat">
            <h2>Sign up for our newsletter and get a gift <span class="icon-svg16"></span></h2>
